  ...
  return (
    <div className="home-container">
      ...
      <Navigatie
        ...
        link2={
          <Fragment>
            <span className="home-text11">Over Mij</span>
          </Fragment>
        }
        link3={
          <Fragment>
            <span className="home-text12">Diensten</span>
          </Fragment>
        }
        link4={
          <Fragment>
      ...
      <Banner
        ...
        heading1={
          <Fragment>
            <span className="home-text17">Administratiekantoor Fincis</span>
          </Fragment>
        }
      ></Banner>
      <OverMij
      ...
      <Diensten
        ...
        sectionTitle={
          <Fragment>
            <span className="home-text58">Diensten</span>
          </Fragment>
        }
        feature1Title={
          <Fragment>
        ...
        feature1Title1={
          <Fragment>
            <span className="home-text62">Inkomstenbelasting-aangifte</span>
          </Fragment>
        }
        feature2Title1={
          <Fragment>
      ...
      <Contact
        ...
        heading1={
          <Fragment>
            <span className="home-text81">Contact</span>
          </Fragment>
        }
        contactId="Contact"
      ></Contact>
      <Footer1
        ...
        cookiesLink={
          <Fragment>
            <span className="home-text87">Algemene Voorwaarden</span>
          </Fragment>
        }
      ></Footer1>
    </div>
